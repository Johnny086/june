...
public class BaseClass {
	...
	public void bcConfig() throws IOException {
		String browser = fUtils.fetchDataFromPropetiesFile("browser");
		String url = fUtils.fetchDataFromPropetiesFile("url");
	...
	public void bmConfig() throws IOException {
		...
		String username = fUtils.fetchDataFromPropetiesFile("username");
		String password = fUtils.fetchDataFromPropetiesFile("password");
